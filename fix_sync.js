...
const regex = /app\.post\('\/api\/appointments\/sync-all', authenticateToken, async \(req: any, res: any\) => \{[\s\S]*?\}\);/m;

const newCode = `app.post('/api/appointments/sync-all', authenticateToken, async (req: any, res: any) => {
   try {
